<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/jo/css/admin_css/adminChat_css/adminChat.css">
		<script src="${pageContext.request.contextPath}/resources/jo/js/admin_js/adminChat_js/adminChat.js"></script>
	</head>
						...
						<div class="col-md-9 no-padding">
										<div class="row">
											...
											<div class="col-md-12">
												<div class="card">
													<div class="card-head">
														<header class="small">채팅 목록
															<span id="comment-count" class="text-primary _count">2</span>
														</header>
													</div>
													...
													<div class="card-body no-padding">
														<div class="li-table">
															...
															<ul class="-tbody holder content">
																...
																<li class="author">
																	<a href="_blank" class="text-primary">두더지</a>
																</li>
																<li class="date" > 2024-05-21 </li>
																<li class="action">
																	<div class="dropdown">
																		<button class="btn btn-primary-button"><a href="privateChat.ad">이동</a></button>
															...
															<ul class="-tbody holder content">
																...
																<li class="author">
																	<a href="publicChat.ad" class="text-primary">크리스탈</a>
																</li>
																<li class="date" > 2024-05-21 </li>
																<li class="action">
																	<div class="dropdown">
																		<button class="btn btn-primary-button"><a href="publicChat.ad">이동</a></button>
																		<button class="btn btn-flat" id="deleteBtn">삭제</button>
																	</div>
																</li>
															</ul>
