<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		...
		<!-- 모달창 -->
		<div id="cocoaModal" class="modal in modal-admin noticeModal" data-backdrop="true" data-keyboard="true" style="display: none;">
			<div class="modal-dialog ui-draggable">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary btn-flat" id="board-save">노출</button>
					</div>                        
				</div>
			</div>
		</div>
