    ...
    <div class="loginwrap">
      ...
      <div class="logobox">
        <a href="../../views/mainPage/MainPage.html">
          <img src="_blank" class="searchlogo"/>
        </a>
        <!-- 로그인바 - 검색바 -->
        <div class="search">
      ...
      <div class="userId">
        ...
        <button class="userName" id="userName" type="button"> 떡꼬치대마왕 님 </button>
      </div>
      <!-- 로그인바 - 로그인 -->
      <!-- <div class="userId">
            <a href="_blank">로그인</a>
    ...
    <div class="catewrap">
      ...
      <div class="categories">
        <div class="cate">
          ...
          <a class="catelist" href="_blank">소셜링</a>
          <a class="catelist" href="_blank">챌린지</a>
        </div>
    ...
    <div class="cateToggle" id="cateToggle">
      <div class="grid">
        ...
        <div class="categrid">
          ...
          <div class="getTitle">
            <div class="cateL">
              <a href="_blank" class="cateT">주간 베스트 20</a>
              <a href="_blank" class="cateT">HOT 클래스</a>
              <a href="_blank" class="cateT">실시간 랭킹</a>
            </div>
          </div>
        </div>
        ...
        <div class="categrid">
          ...
          <div class="getTitle">
            <div class="cateL">
              <a href="_blank" class="cateT">문화 · 예술</a>
              <a href="_blank" class="cateT">푸드 · 드링크</a>
            </div>
          </div>
        </div>
        ...
        <div class="categrid">
          ...
          <div class="getTitle">
            <div class="cateL">
              <a href="_blank" class="cateT">자기계발</a>
              <a href="_blank" class="cateT">재테크</a>
              <a href="_blank" class="cateT">외국어</a>
            </div>
          </div>
        </div>
        ...
        <div class="categrid">
          ...
          <div class="getTitle">
            <div class="cateL">
              <a href="_blank" class="cateT">액비티비</a>
              <a href="_blank" class="cateT">여행 · 동행</a>
            </div>
          </div>
        </div>
        ...
        <div class="categrid">
          ...
          <div class="getTitle">
            <div class="cateL">
              <a href="_blank" class="cateT">취미</a>
              <a href="_blank" class="cateT">파티 · 게임</a>
              <a href="_blank" class="cateT">연애 · 사랑</a>
            </div>
          </div>
        </div>
      </div>
