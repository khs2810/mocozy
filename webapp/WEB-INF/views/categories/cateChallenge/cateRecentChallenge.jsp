...
<script src="${pageContext.request.contextPath}/resources/jo/js/categories_js/cateChallengeAjax.js"></script>
				...
				<div class="catelistTitle">
					...
					<div class="rightlistTitle">
						<div class="rightlistContent">
							<p id="cateRecent"><a href="cateRecent.ct">소셜링</a></p>
							<span id="cateDibs"><a href="cateRecentChallenge.ct">챌린지</a></span>
						</div>
					</div>
				</div>
								...
								<div class="info">
									...
									<div class="participant">
										...
										<div class="socialmember">
													<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="color: gray" class="bi bi-clock" viewBox="0 0 16 16">
