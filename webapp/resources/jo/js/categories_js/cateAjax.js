...
function cateActivityAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
//페이지네이션 처리해서 가져와야함....
function cateActivityAjax(callback){
    $.ajax({
...
function cateDevelopeAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
//페이지네이션 처리해서 가져와야함....
function cateDevelopeAjax(callback){
    $.ajax({
        url: "cateDevelopeAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
//페이지네이션 처리해서 가져와야함....
function cateFoodAjax(callback){
    $.ajax({
        url: "cateFoodAjax.ct",
        success : callback,
        error: function(){
...
//페이지네이션 처리해서 가져와야함....
function cateForeignAjax(callback){
    $.ajax({
        url: "cateForeignAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
//페이지네이션 처리해서 가져와야함....
function cateGameAjax(callback){
    $.ajax({
        url: "cateGameAjax.ct",
        success : callback,
        error: function(){
...
//페이지네이션 처리해서 가져와야함....
function cateHobbyAjax(callback){
    $.ajax({
        url: "cateHobbyAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
//페이지네이션 처리해서 가져와야함....
function cateInvestAjax(callback){
    $.ajax({
        url: "cateInvestAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
//페이지네이션 처리해서 가져와야함....
function cateLoveAjax(callback){
    $.ajax({
        url: "cateLoveAjax.ct",
        success : callback,
        error: function(){
...
//페이지네이션 처리해서 가져와야함....
function cateTravelAjax(callback){
    $.ajax({
        url: "cateArtAjax.ct",
        success : callback,
        error: function(){
