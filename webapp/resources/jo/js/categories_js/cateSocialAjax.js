function cateBestSocialingAjax(list){
...
//페이지네이션 처리해서 가져와야함....
function cateBestSocialingAjax(callback){
    $.ajax({
        url: "cateBestSocialingAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
function cateHotSocialingAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
//페이지네이션 처리해서 가져와야함....
function cateHotSocialingAjax(callback){
    $.ajax({
        url: "cateHotSocialingAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
function cateRecentSocialingAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
function cateDevelopeAjax(callback){
    $.ajax({
        url: "cateRecentSocialingAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
