...
//페이지네이션 처리해서 가져와야함....
function searchFormAjax(callback){
    $.ajax({
        url: "searchFormAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
function searchFormPickAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
//페이지네이션 처리해서 가져와야함....
function searchFormPickAjax(callback){
    $.ajax({
        url: "searchFormPickAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
...
function searchFormViewAjax(list){
    const topBody = document.querySelector(".display");
    $(topBody).empty();
...
//페이지네이션 처리해서 가져와야함....
function searchFormViewAjax(callback){
    $.ajax({
        url: "searchFormViewAjax.ct",
        success : callback,
        error: function(){
            console.log("ajax실패")
        }
