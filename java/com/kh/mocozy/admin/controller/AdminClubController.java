...
public class AdminClubController {
	...
	public String adminClub(@RequestParam(value="cpage", defaultValue="1") int cpage, String sortType, Model model, HttpSession session) {
		// 세션 만료 확인
	...
	public String adminProcess(@RequestParam(value="cpage", defaultValue="1") int currentPage, String sortType, Model model, HttpSession session) throws java.text.ParseException {  
		// 세션 만료 확인
		Member loginUser = (Member)session.getAttribute("loginUser");
		if (loginUser == null) {
			return "redirect:/"; // 메인 페이지로 리다이렉트
	...
	public String adminEnd(@RequestParam(value="cpage", defaultValue="1") int currentPage, String sortType, Model model, HttpSession session) throws java.text.ParseException {  
	...
	public String adminHidden(@RequestParam(value="cpage", defaultValue="1") int currentPage, String sortType, Model model, HttpSession session) throws java.text.ParseException {  
		// 세션 만료 확인
		Member loginUser = (Member)session.getAttribute("loginUser");
		if (loginUser == null) {
			return "redirect:/"; // 메인 페이지로 리다이렉트
